...
<section class="authors">
   ...
   ?>
   <div class="box">
      <p>Автор: <span><?= $fetch_authors['name']; ?></span></p>
      <p>Всего публикаций: <span><?= $total_admin_posts; ?></span></p>
      <p>Всего лайков: <span><?= $total_admin_likes; ?></span></p>
      <p>Всего комментариев: <span><?= $total_admin_comments; ?></span></p>
      <a href="author_posts.php?author=<?= $fetch_authors['name']; ?>" class="btn">Просмотр публикаций</a>
   </div>
   <?php
      }
   }else{
      echo '<p class="empty">Авторов не найдено</p>';
   }
   ?>

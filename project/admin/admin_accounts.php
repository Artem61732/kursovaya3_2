...
<section class="accounts">
   ...
   <h1 class="heading">Аккаунт админа</h1>

   <div class="box-container">

   <div class="box" style="order: -2;">
      <p>Зарегистрировать нового админа</p>
      <a href="register_admin.php" class="option-btn" style="margin-bottom: .5rem;">Добавить</a>
   </div>
   ...
   <div class="box" style="order: <?php if($fetch_accounts['id'] == $admin_id){ echo '-1'; } ?>;">
      ...
      <p> Всего постов : <span><?= $total_admin_posts; ?></span> </p>
      <div class="flex-btn">
         <?php
            if($fetch_accounts['id'] == $admin_id){
         ?>
            <a href="update_profile.php" class="option-btn" style="margin-bottom: .5rem;">Изменить</a>
            <form action="" method="POST">
               <input type="hidden" name="post_id" value="<?= $fetch_accounts['id']; ?>" on>
               <button type="submit" name="delete"onclick="return confirm('Удалить аккаунт?');" class="delete-btn" style="margin-bottom: .5rem;">Удалить</button>
            </form>
         <?php
            }
         ?>

...
<section class="show-posts">
   ...
   <div class="box-container">
      ...
      <form method="post" class="box">
         ...
         <div class="flex-btn">
            <a href="edit_post.php?id=<?= $post_id; ?>" class="option-btn">Изменить</a>
            <button type="submit" name="delete" class="delete-btn" onclick="return confirm('Удалить эту публикацию?');">Удалить</button>
         </div>
         <a href="read_post.php?post_id=<?= $post_id; ?>" class="btn">Просмотр</a>
      </form>
      <?php
            }
         }else{
            echo '<p class="empty">Публикаций ещё нет! <a href="add_posts.php" class="btn" style="margin-top:1.5rem;">Добавить публикацию</a></p>';
         }
      ?>
